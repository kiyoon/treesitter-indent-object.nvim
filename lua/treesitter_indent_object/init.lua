...
M.setup = function(options)
  ...
  vim.g.treesitter_indent_object_strict_tabs =
    o(options.strict_tabs, vim.g.indent_blankline_strict_tabs, vim.g.indent_blankline_strict_tabs, false)

  vim.g.treesitter_indent_object_context_patterns = o(
  ...
  vim.g.treesitter_indent_object_use_treesitter_scope = o(
